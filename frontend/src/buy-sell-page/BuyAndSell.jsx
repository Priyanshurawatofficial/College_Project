...
function BuyAndSell() {
  ...
  const handleSubmit = (e) => {
    ...
    const newItem = {
      ...form,
      id: Date.now(),
      image: preview || "/images/default-item.jpg",
    };
        ...
        {items.map((item) => (
          <div className="col-md-4" key={item.id}>
            <div className="card shadow-sm h-100">
              <img
                src={`${item.type === "sell" ? "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQFs4xa_05ZRIvnlM2c7cVV43td4VHNubEuWw&s" : "https://grafkom.io/wp-content/uploads/2021/01/wanttobuy.jpg"}`}
              ...
              <div className="card-body">
                <span
                  className={`badge mb-2 ${item.type === "sell" ? "bg-primary" : "bg-warning text-dark"}`}
                >
